...
def generate_launch_description():
    ...
    try:
        ...
        raise RuntimeError(
            "turtlesim_init.launch.py requires gazebo_ros, turtlebot3_gazebo, "
            "and turtlebot3_description to be installed."
        ) from exc
    ...
    # Generate robot_description from URDF for TF publication.
    ...
    # Spawn the Gazebo SDF model so the diff-drive plugin subscribes to /cmd_vel.
    spawn_entity = Node(
        package='gazebo_ros',
